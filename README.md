...
| Where | What |
|-------|------|
| `~/.claude/statusline.sh` | model · effort │ project │ git branch │ context │ session cost │ weekly quota bar with an even-pace marker, days ahead/behind pace, and reset countdown in the last 48h |
